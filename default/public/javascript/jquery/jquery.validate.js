...
$.extend($.validator, {
	...
	messages: {
		...
		rangelength: $.validator.format("Por ingrese un valor con una longitud de entre {0} y {1} caracteres."),
		range: $.validator.format("Por favor ingrese un valor entre {0} y {1}."),
		max: $.validator.format("Por favor ingrese una valor menor o igual que {0}."),
